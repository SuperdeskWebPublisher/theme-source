      ...
      <table class="sectionsTable">
        <tr v-for="item in localSections">
          <td class="sectionsTable__slider">
            <slider ref="slider" v-model="item.score" :value="item.score" :min="0" :max="10" :interval="5" :piecewise="true" tooltip="none" :real-time="true" :height="1" :dot-size="10"></slider>
          </td>
    ...
    <div v-if="activeTab=='sources'">
      <table class="sectionsTable">
        <tr v-for="item in localSources">
          <td class="sectionsTable__slider">
            <slider ref="slider" v-model="item.switch" :value="item.switch" :min="0" :max="1" tooltip="none" :real-time="true" :height="1" :dot-size="10"></slider>
          </td>
          <td class="sectionsTable__title">
            {{item.title}}
          </td>
